...
IF EXIST "!FILTER_PLAYER_MODELS_FILE_PATHNAME!" (
	SET FILTER_PLAYER_MODELS_FILE_SIZE=0
	FOR /F %%i IN ("!FILTER_PLAYER_MODELS_FILE_PATHNAME!") DO SET FILTER_PLAYER_MODELS_FILE_SIZE=%%~zi

	REM Temporary...
	ECHO Size: !FILTER_PLAYER_MODELS_FILE_SIZE!
	TYPE "!FILTER_PLAYER_MODELS_FILE_PATHNAME!"
...
IF EXIST "!FILTER_SOUNDS_FILE_PATHNAME!" (
	SET FILTER_SOUNDS_FILE_SIZE=0
	FOR /F %%i IN ("!FILTER_SOUNDS_FILE_PATHNAME!") DO SET FILTER_SOUNDS_FILE_SIZE=%%~zi

	REM Temporary...
	ECHO Size: !FILTER_SOUNDS_FILE_SIZE!
	TYPE "!FILTER_SOUNDS_FILE_PATHNAME!"
